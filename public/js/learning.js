...
document.addEventListener('DOMContentLoaded', function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            metadataURL = URL + "metadata.json"; // load the window.model and metadata
            // Refer to tmImage.loadFromFiles() in the API to support files from a file picker
            // Note: the pose library adds a tmPose object to your window (window.tmPose)

            _context.next = 4;
            return _babel_runtime_regenerator_index_js__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(tmPose.load(modelURL, metadataURL));

          case 4:
            window.model = _context.sent;
            window.maxPredictions = window.model.getTotalClasses(); // Convenience function to setup a window.webcam

            size = 600;
            flip = true; // whether to flip the window.webcam

            window.webcam = new tmPose.Webcam(size, size, flip); // width, height, flip

            _context.next = 11;
            return _babel_runtime_regenerator_index_js__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(window.webcam.setup());

          case 11:
            _context.next = 13;
            return _babel_runtime_regenerator_index_js__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(window.webcam.play());

          case 13:
            window.requestAnimationFrame(loop); // append/get elements to the DOM

            canvas = document.getElementById("webcam-container");
            canvas.width = size;
            canvas.height = size;
    ...
    return _babel_runtime_regenerator_index_js__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _babel_runtime_regenerator_index_js__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(window.model.estimatePose(window.webcam.canvas));

          case 2:
            _ref = _context3.sent;
            pose = _ref.pose;
            posenetOutput = _ref.posenetOutput;
            _context3.next = 7;
            return _babel_runtime_regenerator_index_js__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(window.model.predict(posenetOutput));
  ...
  window.drawPose = function (pose) {
    if (window.webcam.canvas) {
      ctx.drawImage(window.webcam.canvas, 0, 0); // draw the keypoints and skeleton
...
/***/ 1:
/*!****************************************!*\
  !*** multi ./resources/js/learning.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

...
@if(auth()->user()->role==2)
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3>{{$criminal->name}}</h3>
                <form action="{{route('criminals.update',$criminal)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="characteristics" id="characteristics">
                    </div>
                    <div class="form-group">
